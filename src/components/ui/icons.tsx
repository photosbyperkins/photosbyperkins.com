...
/**
 * StoryCropIcon
 * Custom SVG icon blending a smartphone in portrait mode (9:16 silhouette, top speaker
 * notch, bottom home indicator) with the classic intersecting photographic crop mark corners.
 * Used for the Story Maker tool and 9:16 cropping controls.
 */
export const StoryCropIcon = ({ size = 18, className = '', style, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
        ...
        {...props}
    >
        {/* Left-to-bottom crop arm */}
        <path d="M6 2v16a2 2 0 0 0 2 2h14" />
        {/* Right-to-top crop arm */}
